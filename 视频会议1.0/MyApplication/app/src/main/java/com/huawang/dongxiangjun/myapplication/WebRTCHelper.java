...
public class WebRTCHelper {
    ...
    final private String RTCSTUNServerURL2 = "stun:23.21.150.121";

    final private String TAG = "com.huawang.www";
...
/// 内部类
    private class Peer implements SdpObserver, PeerConnection.Observer {
        ...
        private PeerConnection createPeerConnection() {
            ...
            // 管道连接抽象类实现方法
            PeerConnection peerConnection = _factory.createPeerConnection(ICEServers, peerConnectionConstraints(), this);
